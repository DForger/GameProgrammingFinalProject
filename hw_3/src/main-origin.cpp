...
void RenderIt(int skip)
{
   ...
   sprintf_s(keyS, "up: %d, down:%d, left: %d, right, %d", DIR_KEYDOWN[0], DIR_KEYDOWN[1], DIR_KEYDOWN[2], DIR_KEYDOWN[3]);
   sprintf_s(poseS, "pose: %s", ((curPoseID==runID)? "RUN" : "IDLE"));
